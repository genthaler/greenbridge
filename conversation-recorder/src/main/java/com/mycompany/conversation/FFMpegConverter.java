...
public class FFMpegConverter {
    ...
    public FFMpegConverter( String ffmpegcmd) {
    ...
    public void convert(File wav, long bitrate, long frequency, File outputfile, boolean forceOverwrite) throws InterruptedException, IOException {
        ...
        ProcessBuilder pb = new ProcessBuilder(new String[] {ffmpegFullCommand, "-i", wav.getAbsolutePath(), "-y", "-f", "mp3", "-ab", bitrate + "", "-ar", frequency + "", outputfile.getAbsolutePath()} );
    ...
    public static final void main(String[] args) {
        ...
        FFMpegConverter instance = new FFMpegConverter("C:\\Program Files\\FFmpeg for Audacity\\ffmpeg.exe");
        try {
