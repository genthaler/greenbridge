...
public class ConversationManagerImpl implements ConversationManager, MediaTagManager {
    ...
    public ConversationManagerImpl(ConversationDao dao, SlugGenerator slugger, ChapterToolXMLTagParserStrategy tagParser, FullConversationTagParsingStratgey freemindParser) {
        this.dao = dao;
   ...
   public final void setAllMediaTagsMedia(List<MediaTag> mediaTags, Media media) {
    ...
    public ConversationSearchResults listAllConversations(Integer page, Integer limit) throws Exception {
        ...
        System.out.println("There are " + result.size() + " conversations found (manager)");
    ...
    public Long addTag(String conversationId, TagUpdateDetails details) {
        ...
        if (media == null) {
            System.out.println("For some reason the media is null in the add tag");
        }
    ...
    public void deleteTag(String mediaTagID) {
        ...
        System.out.println("We removed, there are now " + media.getMediaTags().size());
        dao.save(media);
    ...
    protected Map<String,String> createMapFromTags(List<Tag> tags) {
        ...
        for (Tag tag : tags) {
            ...
            data.put( tag.getId(), name.toString());
        }
        return data;
    }
    ...
    public Conversation findById(String conversationID) {
        return dao.loadConversationById(conversationID);
    }
